  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div class="flex items-center gap-2 mb-3">
          ...
          >
            ...
            <span class="text-brand-white text-xs font-semibold"
              >+{{ addedThisMonth.toLocaleString() }} bulan ini</span
            >
          </div>
        </div>
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          <p class="text-brand-dark text-sm font-medium">Pegawai Aktif</p>
          ...
          >
            {{ activeChange >= 0 ? "+" : "" }}{{ activeChange }} minggu ini
          </p>
        </div>
        <div
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          <p class="text-brand-dark text-sm font-medium">Pegawai Baru</p>
          <p class="text-brand-dark text-3xl font-extrabold leading-none my-2">
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-success text-sm font-medium">Rata-rata perusahaan</p>
        </div>
        <div
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          <p class="text-brand-dark text-sm font-medium">Cuti</p>
          <p class="text-brand-dark text-3xl font-extrabold leading-none my-2">
          ...
          <p
            ...
            class="text-sm font-medium"
          >
            {{ onLeaveChange >= 0 ? "+" : "" }}{{ onLeaveChange }} dari minggu lalu
          </p>
        </div>
        <div
