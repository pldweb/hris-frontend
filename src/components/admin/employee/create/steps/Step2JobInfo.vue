        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p class="text-brand-light text-sm font-normal">
              Peran, departemen, dan detail pekerjaan
            </p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div class="mb-4">
            <Input
              ...
              label="Jabatan *"
              placeholder="misal: Pengembang Senior"
          ...
          <div class="mb-4">
            ...
            <div class="relative">
              ...
              >
                ...
                >
                  {{ selectedTeam ? selectedTeam.name : "Pilih tim" }}
                </span>
              </div>
              <div
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-brand-light text-xs font-normal">
                    {{ selectedTeam.members_count || 0 }} anggota
                  </p>
                </div>
                <button
                  type="button"
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p class="text-brand-light text-sm font-normal">
              Detail perbankan pegawai untuk pemrosesan penggajian
            </p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div class="mb-4">
            ...
            <p class="text-brand-light text-xs font-normal mt-1">
              Hanya masukkan angka (8-20 digit)
            </p>
          </div>
          ...
          <div class="mb-4 md:col-span-2">
            <Input
              ...
              placeholder="misal: John Doe Smith"
            ...
            <p class="text-brand-light text-xs font-normal mt-1">
              Nama harus sama persis dengan nama pemilik rekening bank
            </p>
          </div>
          ...
          <div class="mb-4">
            <Select
              ...
              :options="[
                { value: 'savings', label: 'Rekening Tabungan' },
                { value: 'checking', label: 'Rekening Giro' },
                { value: 'current', label: 'Rekening Koran' },
              ]"
      ...
      <div class="p-6 border-b border-[#DCDEDD]">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-brand-dark text-xl font-bold">Pilih Tim</h3>
              <p class="text-brand-light text-sm font-normal">
                Pilih tim untuk pegawai ini
              </p>
            </div>
          </div>
          <button
      ...
      <div class="p-6 overflow-y-auto max-h-96">
        ...
        <div class="text-center py-8" v-if="filteredTeams.length === 0">
          ...
          <p class="text-brand-light text-sm">
            Coba sesuaikan istilah pencarian Anda
          </p>
        </div>
      </div>
    </div>
