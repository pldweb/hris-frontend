...
<template>
  ...
  <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-4 sm:p-5">
    <div class="flex items-center justify-between mb-4">
      <h3 class="text-brand-dark text-lg font-bold">Pegawai Terbaru</h3>
    </div>
    ...
    >
      <p class="text-gray-500 text-sm">Tidak ada pegawai ditemukan</p>
    </div>
    ...
    <div v-else class="space-y-4">
      ...
      >
        ...
        <div class="flex-1">
          <div class="flex items-center gap-2 flex-wrap">
            <p class="text-brand-dark text-base sm:text-lg font-bold">
              {{ employee.user?.name || "Tidak diketahui" }}
            </p>
            <span
        ...
        >
          <span class="text-brand-dark text-sm sm:text-base font-medium">Detail</span>
        </button>
      </div>
    </div>
  </div>
