  ...
  <div class="mb-6">
    ...
    <div class="mb-4">
      ...
      <p class="text-gray-600 text-xs sm:text-sm">
        Berikut ringkasan kinerja Anda
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          >
            <div>
              ...
              <p class="text-brand-white-80 text-base font-normal">
                {{ statistics.present_days }} dari {{ currentDayOfMonth }} hari
              </p>
            </div>
            <div
          ...
          <div class="flex items-center gap-3 mt-auto">
            <div class="flex items-center gap-1">
              ...
              <span class="text-brand-white-70 text-xs font-normal"
                >{{ onTimePercentage }}% Tepat Waktu</span
              >
            </div>
            <div class="flex items-center gap-1">
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-sm font-medium">Jam Kerja</p>
            <p
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-sm font-medium">Sisa Cuti</p>
            <p
              class="text-brand-dark text-2xl sm:text-3xl font-extrabold leading-tight my-2"
            >
              {{ loading ? "..." : statistics.leave_balance ?? "-" }}
            </p>
            <p class="text-gray-500 text-sm font-medium">Hari tersisa</p>
          </div>
          <div
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-success text-sm font-medium">
              +{{ statistics.tasks_done_yesterday || 0 }} kemarin
            </p>
          </div>
          <div
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-4 sm:p-6">
      <div class="flex items-center justify-between mb-4">
        ...
        <a
          href="#"
          @click.prevent="() => {}"
          class="text-[#0C51D9] text-xs sm:text-sm font-medium hover:underline cursor-not-allowed opacity-50"
          >Lihat Semua</a
        >
      </div>
