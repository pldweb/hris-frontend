      ...
      >
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 p-8 text-center">
          ...
          <p class="text-brand-light text-base">
            Permintaan cuti Anda telah berhasil dikirim
          </p>
        </div>
        ...
        <div class="p-6 space-y-4" v-if="leaveData">
          ...
          >
            ...
            <div class="flex items-center justify-between">
              <span class="text-brand-dark text-sm font-medium">Jenis Cuti</span>
            ...
            <!-- Duration -->
            <div class="flex items-center justify-between">
              <span class="text-brand-dark text-sm font-medium">Durasi</span>
            ...
            <!-- Date Range -->
            <div class="flex items-center justify-between">
              <span class="text-brand-dark text-sm font-medium">Periode</span>
              <div class="flex items-center gap-2">
          ...
          >
            ...
            <p class="text-brand-dark text-sm leading-relaxed">
              Anda akan menerima pemberitahuan setelah permintaan Anda ditinjau oleh manajer Anda.
            </p>
          </div>
          ...
          >
            <span class="text-brand-white text-base font-semibold">Mengerti!</span>
          </button>
        </div>
      </div>
    </div>
