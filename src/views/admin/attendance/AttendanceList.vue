    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div class="flex items-center gap-2 mb-3">
            ...
            >
              ...
              <span class="text-brand-white text-xs font-semibold"
                >+{{ statistics.present_change || 0 }} dari kemarin</span
              >
            </div>
          </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-brand-dark text-sm font-medium">Absen Hari Ini</p>
              <p
              ...
              <p class="text-danger text-xs font-medium">
                ...
                }}{{ statistics.absent_change || 0 }} dari kemarin
              </p>
            </div>
            <div
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-brand-dark text-sm font-medium">Kedatangan Terlambat</p>
              <p
                class="text-brand-dark text-2xl font-extrabold leading-tight my-1"
              >
                {{ statistics.late_today || 0 }}
              </p>
              <p class="text-warning text-xs font-medium">Setelah 09:00 AM</p>
            </div>
            <div
      ...
      <div class="flex flex-col gap-4">
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-brand-dark text-sm font-medium">Sedang Cuti</p>
              <p
                class="text-brand-dark text-2xl font-extrabold leading-tight my-1"
              >
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-brand-dark text-sm font-medium">Pekerja Jarak Jauh</p>
              <p
                class="text-brand-dark text-2xl font-extrabold leading-tight my-1"
              >
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-success text-xs font-medium">
                ...
                }}{{ statistics.rate_change || 0 }}% dari minggu lalu
              </p>
            </div>
            <div
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-warning text-xs font-medium">Menunggu persetujuan</p>
            </div>
            <div
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        <div class="flex items-center justify-between mb-6">
          ...
          <a
            class="btn-secondary text-brand-dark text-sm font-semibold border border-[#DCDEDD] rounded-[8px] hover:border-[#0C51D9] hover:border-2 hover:bg-gray-50 transition-all duration-300 px-3 py-2 cursor-pointer"
          >
            Lihat Semua
          </a>
        </div>
            ...
            <div class="flex-1">
              ...
              <div class="flex items-center gap-2">
                ...
                <span class="text-brand-dark text-xs">
                  ...
                  {{ formatDate(request.end_date) }} ({{ request.days }} hari)
                </span>
              </div>
            </div>
            <div
        ...
        <div class="flex items-center justify-between mb-6">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-brand-light text-sm">Siapa saja yang ada di kantor hari ini</p>
            </div>
          </div>
          <RouterLink
        ...
        <div v-else class="space-y-4">
          ...
          >
            ...
            <div class="flex-1">
              ...
              <p class="text-brand-light text-sm">
                Tim
                {{ attendance.employee?.jobInformation?.team?.name || "Tidak diketahui" }}
              </p>
            </div>
            <div class="flex items-center gap-3">
              <span
              ...
              <div class="text-right">
                ...
                <p class="text-brand-light text-xs">Waktu masuk</p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-white rounded-[20px] p-8 max-w-md w-full mx-4">
        <div class="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p class="text-brand-light text-sm">
              Konfirmasi persetujuan untuk permintaan cuti ini
            </p>
          </div>
        </div>
        ...
        <div class="flex gap-3">
          ...
          >
            {{ processingAction ? "Menyetujui..." : "Setujui" }}
          </button>
        </div>
      </div>
    </div>
      ...
      <div class="bg-white rounded-[20px] p-8 max-w-md w-full mx-4">
        <div class="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p class="text-brand-light text-sm">
              Konfirmasi penolakan untuk permintaan cuti ini
            </p>
          </div>
        </div>
        ...
        <div class="flex gap-3">
          ...
          >
            {{ processingAction ? "Menolak..." : "Tolak" }}
          </button>
        </div>
      </div>
    </div>
