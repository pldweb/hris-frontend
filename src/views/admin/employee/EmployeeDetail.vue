...
const backupEmployee = () => {
  if (
    confirm(
      `Buat cadangan untuk ${employee.value?.user?.name}? Ini akan mengunduh semua data pegawai.`
    )
  ) {
    alert("Fitur cadangan akan segera diimplementasikan.");
  }
};
  ...
  <div v-else-if="employee">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-base font-medium">Tugas Selesai</p>
            <p
              class="text-brand-dark text-3xl font-extrabold leading-tight my-2"
            >
              {{ loading ? "..." : performanceStatistics.tasks_completed }}
            </p>
            <p class="text-success text-base font-medium">Bulan ini</p>
          </div>
          <div
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-base font-medium">Tingkat Kehadiran</p>
            <p
              class="text-brand-dark text-3xl font-extrabold leading-tight my-2"
            >
              {{
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-base font-medium">Proyek</p>
            <p
              class="text-brand-dark text-3xl font-extrabold leading-tight my-2"
            >
              {{ loading ? "..." : performanceStatistics.projects_count }}
            </p>
            <p class="text-success text-base font-medium">Proyek aktif</p>
          </div>
          <div
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-base font-medium">Kinerja</p>
            <p
              class="text-brand-dark text-3xl font-extrabold leading-tight my-2"
            >
              {{
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 class="text-brand-dark text-lg font-bold">Informasi Tim</h3>
            <p class="text-brand-light text-sm">
              Tim saat ini dan struktur pelaporan
            </p>
          </div>
        </div>
        <div class="space-y-4">
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Tim</span>
            <span class="text-brand-dark text-base font-medium">
              {{ employee.team?.name || "-" }}
            </span>
          </div>
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Anggota Tim</span>
            <span class="text-brand-dark text-base font-medium">
              {{ employee.team?.members_count || 0 }} anggota
            </span>
          </div>
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Status Tim</span>
            <span class="text-brand-dark text-base font-medium">
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 class="text-brand-dark text-lg font-bold">Detail Kontak</h3>
            <p class="text-brand-light text-sm">Cara menghubungi pegawai ini</p>
          </div>
        </div>
        <div class="space-y-4">
          <div class="flex justify-between items-center">
          ...
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Nomor Identitas</span>
            <span class="text-brand-dark text-base font-medium">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p class="text-brand-light text-sm">Kelahiran dan detail pribadi</p>
          </div>
        </div>
        <div class="space-y-4">
          <div class="flex justify-between items-center">
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 class="text-brand-dark text-lg font-bold">Kontak Darurat</h3>
            <p class="text-brand-light text-sm">
        ...
        <div v-else class="text-center py-4">
          <p class="text-brand-light text-sm">
            Tidak ada informasi kontak darurat
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p class="text-brand-light text-sm">Detail lokasi dan pos</p>
          </div>
        </div>
        <div class="space-y-4">
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p class="text-brand-light text-sm">
              Pengaturan dan kompensasi kerja
            </p>
          </div>
        </div>
        <div class="space-y-4">
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Tahun Pengalaman</span>
            <span class="text-brand-dark text-base font-medium">
              {{ employee.job_information?.years_experience }} tahun
            </span>
          </div>
          <div class="flex justify-between items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
        ...
        <div class="space-y-4">
          ...
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Bahasa Pilihan</span>
            <span class="text-brand-dark text-base font-medium">
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 class="text-brand-dark text-lg font-bold">Informasi Bank</h3>
            <p class="text-brand-light text-sm">Detail perbankan untuk penggajian</p>
          </div>
        </div>
        <div class="space-y-4">
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Nama Bank</span>
            <span class="text-brand-dark text-base font-medium">
              {{ capitalize(employee.bank_information?.bank_name) }}
            </span>
          </div>
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Nomor Rekening</span>
            <span class="text-brand-dark text-base font-medium">
              {{ employee.bank_information?.account_number }}
            </span>
          </div>
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Pemilik Rekening</span>
            <span class="text-brand-dark text-base font-medium">
              {{ employee.bank_information?.account_holder_name }}
            </span>
          </div>
          <div class="flex justify-between items-center">
            <span class="text-brand-light text-base">Jenis Rekening</span>
            <span class="text-brand-dark text-base font-medium">
    ...
    <div class="bg-white border border-[#FEE2E2] rounded-[16px] p-6">
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 class="text-brand-dark text-lg font-bold">Zona Berbahaya</h3>
          <p class="text-brand-light text-sm">
      ...
      >
        <div class="flex-1">
          ...
          <p class="text-brand-light text-sm">
            Hapus pegawai secara permanen dan semua data terkait. Tindakan ini tidak dapat diurungkan.
          </p>
        </div>
        <div class="flex gap-3">
          <button
    ...
    <ConfirmationModal
      ...
      title="Hapus Pegawai"
      :message="`Apakah Anda yakin ingin menghapus '${employee.user?.name}'? Tindakan ini tidak dapat diurungkan.`"
