  ...
  <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h3 class="text-brand-dark text-xl font-bold">Semua Proyek</h3>
          <p class="text-brand-light text-sm font-normal">
            Lihat dan kelola semua informasi proyek
          </p>
        </div>
      </div>
      <div class="flex items-center gap-4" v-if="can('project-create')">
        ...
        >
          ...
          <span class="text-sm font-semibold">Impor CSV</span>
        </button>
        <RouterLink
    ...
    <div class="text-center py-12" v-if="projects.length === 0">
      ...
      <p class="text-brand-light text-sm">
        Coba sesuaikan kata pencarian atau filter Anda
      </p>
    </div>
  </div>
