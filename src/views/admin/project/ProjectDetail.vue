              ...
              <div class="mt-4 pt-4 border-t border-[#DCDEDD]">
                <div v-if="team.leader" class="flex items-center gap-3">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-brand-light text-xs">Pemimpin Tim</p>
                  </div>
                </div>
                <div
                  v-else
    ...
    <div class="space-y-4">
      ...
      >
        <div class="flex items-center justify-between mb-4">
          <div>
            <p class="text-brand-dark text-sm font-medium">Progres</p>
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-sm font-medium">Anggaran</p>
            <p class="text-brand-dark text-xl font-extrabold leading-none my-2">
              {{ formatRupiah(project.budget) }}
            </p>
            <p class="text-success text-sm font-medium">Anggaran proyek</p>
          </div>
          <div
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-sm font-medium">Tanggal Mulai</p>
            <p class="text-brand-dark text-xl font-extrabold leading-none my-2">
              {{ formatDate(project.start_date) || "N/A" }}
            </p>
            <p class="text-indigo-600 text-sm font-medium">Awal mula proyek</p>
          </div>
          <div
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-sm font-medium">Tanggal Berakhir</p>
            <p class="text-brand-dark text-xl font-extrabold leading-none my-2">
              {{ formatDate(project.end_date) || "N/A" }}
            </p>
            <p class="text-orange-600 text-sm font-medium">Tenggat waktu proyek</p>
          </div>
          <div
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-sm font-medium">Durasi</p>
            <p class="text-brand-dark text-xl font-extrabold leading-none my-2">
              {{ calculateDuration(project.start_date, project.end_date) }}
            </p>
            <p class="text-blue-600 text-sm font-medium">Garis waktu proyek</p>
          </div>
          <div
