...
const handleMarkAsPaid = async () => {
  try {
    ...
    alert("Penggajian berhasil ditandai sebagai telah dibayar!");
  } catch (error) {
    console.error("Error marking payroll as paid:", error);
    alert("Gagal menandai penggajian. Silakan coba lagi.");
  } finally {
...
<template>
  <div class="space-y-6">
    ...
    <button @click="router.back()"
      ...
      <span class="text-brand-dark text-base font-semibold">Kembali</span>
    </button>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div
        ...
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-sm font-medium">Total Penggajian</p>
            <p class="text-brand-dark text-3xl font-extrabold leading-tight my-2">
              {{ loadingStatistics ? "..." : formatRupiahCompact(payrollStatistics?.total_amount || 0) }}
            </p>
            <p class="text-success text-sm font-medium">Periode ini</p>
          </div>
      ...
      <div
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-success text-sm font-medium">Per pegawai</p>
          </div>
      ...
      <div
        ...
        <div class="flex items-center justify-between">
          <div>
            <p class="text-brand-dark text-sm font-medium">Diproses Pada</p>
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h3 class="text-brand-dark text-xl font-bold">Detail Pegawai</h3>
            <p class="text-brand-light text-sm font-normal">
              Rincian penggajian lengkap per pegawai
            </p>
          </div>
        </div>
            ...
            <tr v-for="emp in filteredEmployees" :key="emp.id"
              ...
              <td class="py-4 px-4 text-center">
                <span class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-semibold">
                  {{ emp.status === "paid" ? "Dibayar" : "Tertunda" }}
                </span>
              </td>
            </tr>
          </tbody>
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-brand-dark text-lg font-bold">Ekspor & Aksi</h3>
          <p class="text-brand-light text-sm font-normal mt-1">
            Unduh laporan dan kelola data penggajian
          </p>
        </div>
        ...
        <div class="flex items-center gap-3">
          <button @click="exportExcel"
            ...
            <span class="text-brand-dark text-sm font-semibold">Ekspor Excel</span>
          </button>
          ...
          <button v-if="payroll?.status !== 'paid'" @click="openMarkAsPaidModal"
            ...
            <span class="text-green-700 text-sm font-semibold">Tandai Dibayar</span>
          </button>
          ...
          <button v-else @click="sendNotifications"
            ...
            <span class="text-brand-white text-sm font-semibold">Kirim Notifikasi</span>
          </button>
        </div>
      </div>
    </div>
        ...
        <div class="bg-white rounded-[20px] p-6 max-w-md w-full mx-4">
          ...
          <div class="mb-6">
            <p class="text-brand-light text-sm mb-4">
              Konfirmasi bahwa Anda ingin menandai penggajian ini sebagai telah dibayar. Tindakan ini
              akan memperbarui status dan mencatat tanggal pembayaran.
            </p>
          ...
          <div class="flex items-center gap-3">
            <button @click="handleMarkAsPaid" :disabled="markingAsPaid"
              ...
              <span class="text-brand-white text-sm font-semibold">
                {{ markingAsPaid ? "Memproses..." : "Konfirmasi Pembayaran" }}
              </span>
            </button>
