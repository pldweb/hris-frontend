      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 class="text-brand-dark text-xl font-bold">Buat Penggajian</h3>
              <p class="text-brand-light text-sm font-normal">
                Pilih bulan gaji untuk membuat penggajian bagi seluruh pegawai aktif
              </p>
            </div>
          </div>
          ...
          <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-[12px] flex items-start gap-3">
            ...
            <div>
              <h4 class="text-blue-900 text-sm font-semibold mb-1">Pembuatan Otomatis</h4>
              <p class="text-blue-800 text-sm">
                Penggajian akan dibuat secara otomatis untuk seluruh pegawai aktif berdasarkan catatan kehadiran mereka pada bulan yang dipilih. Gaji akan dihitung berdasarkan kehadiran, hari sakit, dan absen.
              </p>
            </div>
          </div>
        </div>
        ...
        <div v-if="error" class="bg-red-50 border border-red-200 rounded-[16px] p-4 flex items-start gap-3">
          ...
          <div>
            <h4 class="text-red-900 text-sm font-semibold mb-1">Kesalahan</h4>
    ...
    <div class="w-100 flex-shrink-0">
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6 sticky top-6">
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 class="text-brand-dark text-xl font-bold">Ringkasan Penggajian</h3>
            <p class="text-brand-light text-sm font-normal">Detail pembuatan</p>
          </div>
        </div>
          ...
          <div class="space-y-3 pt-4 border-t border-gray-100">
            ...
            >
              <span class="text-brand-white text-base font-semibold">{{
                loading ? "Membuat..." : "Buat Penggajian"
              }}</span>
