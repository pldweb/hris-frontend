...
<template>
    ...
    >
      ...
      <div class="flex-1 relative">
        ...
        <input
          ...
          placeholder="Cari tim berdasarkan nama, pemimpin, status..."
      ...
      <div class="flex flex-col sm:flex-row sm:items-center gap-3 w-full sm:w-auto">
        ...
        <div class="relative w-full sm:w-auto">
          ...
          >
            ...
            <option value="forming">Pembentukan</option>
  ...
  <div class="bg-white border border-[#DCDEDD] rounded-[20px] mb-6 p-4 sm:p-5">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
      <div>
        <h3 class="text-brand-dark text-xl font-bold">Semua Tim</h3>
        <p class="text-brand-light text-sm font-normal mt-1">
          Menampilkan {{ meta.from }} - {{ meta.to }} dari {{ meta.total }} tim
        </p>
      </div>
      <div class="flex flex-col sm:flex-row sm:items-center gap-2 w-full sm:w-auto">
        ...
        >
          ...
          <span class="text-brand-dark text-sm font-semibold">Impor CSV</span>
        </button>
        <RouterLink
        ...
        >
          ...
          <span class="text-brand-white text-sm font-semibold">Tambah Tim</span>
        </RouterLink>
      </div>
    </div>
    ...
    <div v-else class="text-center py-8">
      <p class="text-gray-500 text-sm">Tidak ada tim ditemukan</p>
    </div>
