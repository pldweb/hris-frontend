...
<template>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
      ...
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h3 class="text-brand-dark text-lg font-bold">Pemimpin Tim</h3>
      ...
      <div class="flex flex-col gap-4" v-if="team.leader">
        ...
        <div class="space-y-3">
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <div class="flex-1">
                <p class="text-brand-light text-xs font-medium">Nomor Telepon</p>
        ...
        <div class="flex gap-2 mt-4 pt-4 border-t border-[#DCDEDD]">
          ...
          >
            ...
            <span class="text-brand-dark text-base font-semibold">Pesan</span>
          </button>
          <button
            class="flex-1 border border-[#DCDEDD] rounded-[8px] hover:border-[#0C51D9] hover:border-2 hover:bg-gray-50 transition-all duration-300 px-3 py-2 flex items-center justify-center gap-2"
          >
      ...
      <div class="flex flex-1 items-center justify-center min-h-[250px]" v-else>
        <div class="flex flex-col items-center justify-center">
          ...
          <h3 class="text-brand-dark text-lg font-bold mb-2">
            Tidak Ada Pemimpin Tim
          </h3>
          <p class="text-brand-light text-sm mb-4 text-center">
            Tim ini saat ini tidak memiliki pemimpin yang ditugaskan.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 class="text-brand-dark text-lg font-bold">Pengaturan Tim</h3>
          <p class="text-brand-light text-sm">Konfigurasi dan status</p>
        </div>
      </div>
      <div class="space-y-3">
        ...
        <div class="flex justify-between items-center">
          <span class="text-brand-light text-base">Perkiraan Ukuran</span>
          <span class="text-brand-dark text-base font-medium">
            {{ team.expected_size }} anggota
          </span>
        </div>
        <div class="flex justify-between items-center">
          <span class="text-brand-light text-base">Tanggal Dibuat</span>
          <span class="text-brand-dark text-base font-medium">
  ...
  <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6 mb-6">
    <div class="flex items-center gap-3 mb-6">
      ...
      <div>
        <h3 class="text-brand-dark text-lg font-bold">Tanggung Jawab Tim</h3>
        <p class="text-brand-light text-sm">Tugas utama dan sasaran</p>
      </div>
    </div>
  ...
  <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6 mb-6">
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h3 class="text-brand-dark text-lg font-bold">Anggota Tim</h3>
          <p class="text-brand-light text-sm">Komposisi tim saat ini</p>
        </div>
      </div>
      <div class="flex items-center gap-4">
        <button
        ...
        >
          ...
          <span class="text-brand-white text-sm font-semibold">Tambah Anggota</span>
        </button>
      </div>
    </div>
      ...
      >
        ...
        <div class="space-y-1 mb-3">
          <div class="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>Bergabung {{ formatToClientTimezone(member.joined_at) }}</span>
          </div>
          <div class="flex items-center gap-2 text-sm text-gray-500">
            <Clock class="w-4 h-4" />
            <span
              >{{ member.employee.job_information.experience }} tahun
              pengalaman</span
            >
          </div>
        </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 class="text-brand-dark text-lg font-bold">Aktivitas Terbaru</h3>
          <p class="text-brand-light text-sm">
            Pembaruan dan pencapaian tim terbaru
          </p>
        </div>
      </div>
      <div class="space-y-4">
        <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-[12px]">
          ...
          <div class="flex-1">
            <p class="text-brand-dark text-sm font-medium">
              Pencapaian proyek selesai: Fase Integrasi API
            </p>
            <p class="text-brand-light text-xs">3 hari yang lalu</p>
          </div>
        ...
        <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-[12px]">
          ...
          <div class="flex-1">
            <p class="text-brand-dark text-sm font-medium">
              Anggota tim baru bergabung: Emily Rodriguez
            </p>
            <p class="text-brand-light text-xs">1 minggu yang lalu</p>
          </div>
          <div class="flex items-center gap-1 text-blue-600">
            <UserPlus class="w-4 h-4" />
            <span class="text-sm font-medium">Anggota Ditambahkan</span>
          </div>
        </div>
        <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-[12px]">
          ...
          <div class="flex-1">
            <p class="text-brand-dark text-sm font-medium">
              Sesi pelatihan tim diadakan: Pola React Tingkat Lanjut
            </p>
            <p class="text-brand-light text-xs">2 minggu yang lalu</p>
          </div>
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 class="text-brand-dark text-lg font-bold">Sumber Daya Tim</h3>
          <p class="text-brand-light text-sm">Alat dan dokumen penting</p>
        </div>
      </div>
      <div class="space-y-4">
        <div
        ...
        >
          ...
          <div class="flex-1">
            <p class="text-brand-dark text-sm font-medium">Kalender Tim</p>
            <p class="text-brand-light text-xs">Rapat dan tenggat waktu</p>
          </div>
          <ExternalLink class="w-4 h-4 text-gray-400" />
        </div>
        <div
        ...
        >
          ...
          <div class="flex-1">
            <p class="text-brand-dark text-sm font-medium">Obrolan Tim</p>
            <p class="text-brand-light text-xs">Saluran komunikasi</p>
          </div>
          <ExternalLink class="w-4 h-4 text-gray-400" />
        </div>
      </div>
  ...
  <div class="bg-white border border-[#FEE2E2] rounded-[16px] p-6">
    <div class="flex items-center gap-3 mb-6">
      ...
      <div>
        <h3 class="text-brand-dark text-lg font-bold">Zona Bahaya</h3>
        <p class="text-brand-light text-sm">
    ...
    >
      <div class="flex-1">
        <h4 class="text-brand-dark text-base font-bold mb-1">Bubarkan Tim</h4>
        <p class="text-brand-light text-sm">
          Hapus tim ini secara permanen dan alihkan semua anggota. Tindakan ini tidak dapat dibatalkan.
        </p>
      </div>
      <button
  ...
  <ConfirmationModal
    ...
    title="Bubarkan Tim"
    :message="`Apakah Anda yakin ingin membubarkan '${team.name}'? Ini akan menghapus tim secara permanen dan mengalihkan semua anggota. Tindakan ini tidak dapat dibatalkan.`"
    confirmText="Bubarkan Tim"
    cancelText="Batal"
    type="danger"
    :loading="loading"
    ...
    >
      ...
      <div class="p-6 border-b border-[#DCDEDD]">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-brand-dark text-xl font-bold">Tambah Anggota Tim</h3>
              <p class="text-brand-light text-sm font-normal">
                Pilih pegawai untuk ditambahkan ke tim ini
              </p>
            </div>
          </div>
          <button
      ...
      <div class="p-6 overflow-y-auto max-h-96">
        ...
        <div class="text-center py-8" v-if="availableEmployees.length === 0">
          ...
          <p class="text-brand-light text-sm">
            Semua pegawai sudah menjadi anggota tim ini atau coba sesuaikan kata pencarian Anda
          </p>
        </div>
      </div>
    </div>
