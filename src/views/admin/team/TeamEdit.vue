      ...
      <form class="space-y-6" @submit.prevent="handleSubmit" v-if="!loading">
          ...
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-brand-light text-sm font-normal">
                Detail dasar dan deskripsi tim
              </p>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <p class="text-brand-light text-xs">
                    SVG, PNG hingga 1MB (disarankan: format ikon)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="mb-4">
              <Input
                ...
                label="Perkiraan Ukuran Tim"
                placeholder="Masukkan perkiraan ukuran tim"
            ...
            <div class="md:col-span-2">
              <TextArea
                ...
                label="Tujuan Tim"
                placeholder="Deskripsikan tujuan dan sasaran tim..."
        ...
        <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 class="text-brand-dark text-xl font-bold">Pemimpin Tim</h3>
              <p class="text-brand-light text-sm font-normal">
                Tugaskan pemimpin tim untuk mengelola tim ini
              </p>
            </div>
          </div>
            ...
            <div class="md:col-span-2">
              ...
              >
                ...
                <span class="text-[#0D2929] font-normal flex-1">
                  {{ selectedLead?.user?.name || "Pilih pemimpin tim" }}
                </span>
        ...
        <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-brand-light text-sm font-normal">
                Tentukan tanggung jawab dan tugas utama untuk tim ini
              </p>
            </div>
          </div>
          ...
          <div class="space-y-4" id="responsibilitiesContainer">
            ...
            >
              <Input
                ...
                :label="`Tanggung Jawab ${index} *`"
                :error="error?.responsibilities?.[index - 1]?.join(', ')"
                :required="true"
                placeholder="cth., Mengembangkan dan memelihara aplikasi perangkat lunak"
              >
                <template #icon>
              ...
              >
                ...
                <div class="flex gap-3 items-start justify-center">
                  <Input
                    ...
                    :required="true"
                    placeholder="Masukkan tanggung jawab tambahan"
                    class="flex-1"
                  >
                    <template #icon>
                      <CheckCircle class="h-5 w-5 text-gray-400" />
          ...
          <div class="mt-4">
            ...
            >
              ...
              <span class="text-brand-dark text-base font-medium"
                >Tambah Tanggung Jawab Lain</span
              >
            </button>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-brand-light text-sm font-normal">
                Pilih pegawai untuk memimpin tim ini
              </p>
            </div>
          </div>
          <button
