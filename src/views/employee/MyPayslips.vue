...
<template>
  <div>
    <!-- Header Section -->
    <div class="mb-6">
      <h2 class="text-[#0C1C3C] font-bold text-2xl mb-2">Slip Gaji Saya</h2>
      <p class="text-gray-600">Lihat dan unduh slip gaji Anda</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      >
        ...
        <p class="text-white/80 text-sm font-medium mb-2">Total Slip Gaji</p>
      ...
      >
        ...
        <p class="text-brand-dark text-sm font-medium mb-2">Total Penghasilan</p>
        <p class="text-brand-dark text-xl font-extrabold">
          {{ formatCurrency(totalEarnings) }}
        </p>
        <p class="text-success text-sm font-medium mt-1">Tahun ini</p>
      </div>
      ...
      >
        ...
        <p class="text-brand-dark text-sm font-medium mb-2">Total Potongan</p>
        <p class="text-brand-dark text-xl font-extrabold">
          {{ formatCurrency(totalDeductions) }}
        </p>
        <p class="text-danger text-sm font-medium mt-1">Tahun ini</p>
      </div>
    </div>
      ...
      <div class="flex flex-col md:flex-row gap-4">
        <div class="flex-1 relative">
          ...
          <input
            ...
            placeholder="Cari slip gaji berdasarkan bulan atau tahun..."
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-5 mb-6">
      <div class="mb-6">
        <h3 class="text-[#0C1C3C] font-bold text-xl">Semua Slip Gaji</h3>
        <p class="text-gray-600 text-sm mt-1">
          Menampilkan {{ meta.from }} - {{ meta.to }} dari {{ meta.total }} slip gaji
        </p>
      </div>
      ...
      >
        ...
        <p class="text-lg font-semibold">Tidak ada slip gaji yang ditemukan</p>
        <p class="text-sm">Slip gaji Anda akan muncul di sini setelah diproses</p>
      </div>
