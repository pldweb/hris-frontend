  ...
  <div>
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-8 max-w-4xl mx-auto">
      <div v-if="loading" class="text-center py-12">
        <p class="text-gray-500">Memuat slip gaji...</p>
      </div>
      ...
      <div v-else-if="payslip">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div class="bg-green-50 rounded-[16px] p-6">
            <div class="flex items-center gap-2 mb-4">
              ...
              <h3 class="text-lg font-bold text-green-900">Penghasilan</h3>
            </div>
            <div class="space-y-3">
              <div class="flex items-center justify-between">
                <span class="text-sm text-green-700">Gaji Pokok</span>
              ...
              >
                <span class="text-sm text-green-700">Tunjangan</span>
                <span class="font-semibold text-green-900">
              ...
              >
                <span class="text-sm font-bold text-green-900">Gaji Kotor</span>
          ...
          <div class="bg-red-50 rounded-[16px] p-6">
            <div class="flex items-center gap-2 mb-4">
              ...
              <h3 class="text-lg font-bold text-red-900">Potongan</h3>
            </div>
            <div class="space-y-3">
              <div
                v-if="payslip.tax > 0"
                class="flex items-center justify-between"
              >
                <span class="text-sm text-red-700">Pajak</span>
              ...
              <div
                ...
                class="flex items-center justify-between"
              >
                <span class="text-sm text-red-700">Asuransi</span>
                <span class="font-semibold text-red-900">
              ...
              <div
                ...
                class="flex items-center justify-between"
              >
                <span class="text-sm text-red-700">Potongan Lainnya</span>
                <span class="font-semibold text-red-900">
              ...
              >
                <span class="text-sm font-bold text-red-900">Total Potongan</span>
        ...
        <div class="mt-8 pt-6 border-t border-gray-200 text-center">
          <p class="text-xs text-gray-500">
            Ini adalah slip gaji yang dihasilkan oleh komputer dan tidak memerlukan tanda tangan.
          </p>
          <p class="text-xs text-gray-500 mt-1">
            Untuk pertanyaan apa pun, silakan hubungi departemen HR.
          </p>
        </div>
      </div>

      <div v-else class="text-center py-12">
        <p class="text-gray-500">Slip gaji tidak ditemukan</p>
      </div>
    </div>
  </div>
</template>
